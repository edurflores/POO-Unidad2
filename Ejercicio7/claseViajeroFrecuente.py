class ViajeroFrecuente:
    ...
    def __radd__(self, xcantmill): ### Sobrecarga por derecha de operador suma
        return ViajeroFrecuente(self.__num_viajero, self.__dni, self.__nombre, self.__apellido, xcantmill + self.__millas_acum)
    ...
    def __rsub__(self, xcantmill): ### Sobrecarga por derecha de operador resta
        return ViajeroFrecuente(self.__num_viajero, self.__dni, self.__nombre, self.__apellido, self.__millas_acum - xcantmill)
